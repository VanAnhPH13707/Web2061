            ...
            <div class="mx-auto container xl:px-20 lg:px-12 sm:px-6 px-4 px-4 py-12">
                <div class="grid grid-cols-5 mt-10">
                    <div class="block">
                        ...
                        <p class="mb-3 text-xs">Hotline: 1900-6035</P>
                        <p class="mb-3 text-xs">(1000 đ/phút, 8-21h kể cả T7, CN)</p>
                        <p class="mb-3 text-xs"> <a href="" class="">Các câu hỏi thường gặp</a></p>
                        <p class="mb-3 text-xs"> <a href="" class="">Gửi yêu cầu hỗ trợ</a></p>
                    </div>
                    <div class="">
                        <h3 class="font-bold pb-5">Về cửa hàng</h3>    
                        <p class="mb-3 text-xs">Giới thiệu</p>
                        <p class="mb-3 text-xs">Tuyển dụng</p>
                        <p class="mb-3 text-xs"> <a href="" class="">Chính sách bảo mật</a></p>
                        <p class="mb-3 text-xs"> <a href="" class="">Điều khoản sử dụng</a></p>
                    </div>
                    <div class="">
                        <h3 class="font-bold pb-5">Hợp tác và liên kết</h3>    
                        <p class="mb-3 text-xs">Quy chế hoạt động</p>
                        <p class="mb-3 text-xs"> <a href="" class="">Bán hàng cùng Tiki</a></p>
                        <p class="mb-3 text-xs"> <a href="" class="">Các câu hỏi thường gặp</a></p>
                    </div>
                    <div class="">
                        <h3 class="font-bold pb-5">Phương thức thanh toán</h3>    
                        <p class="mb-3 text-xs">Hotline: 1900-6035</p>
                        <p class="mb-3 text-xs"> <a href="" class="">Các câu hỏi thường gặp</a></p>
                        <p class="mb-3 text-xs"> <a href="" class="">Các câu hỏi thường gặp</a></p>
                    </div>
                    <div class="">
                        <h3 class="font-bold pb-5">Kết nối với chúng tôi</h3>    
